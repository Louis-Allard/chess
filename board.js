    ...
    for (let c = 1; c < 9; c++) {
        ...
        for (let i = 0; i < col.length; i++) {
            ...
            if (j === c) {
                ...
                if (col[i] === "E" && l === 1) {
                    document.write('<div class="w_king on" title="King"></div>')
                }
                if (col[i] === "D" && l === 1) {
                    document.write('<div class="w_queen on" title="Queen"></div>')
                }
                if ((col[i] === "C" && l === 1) || (col[i] === "F" && l === 1)) {
                    document.write('<div class="w_bishop on" title="Bishop"></div>')
                }
                if ((col[i] === "B" && l === 1) || (col[i] === "G" && l === 1)) {
                    document.write('<div class="w_knight on" title="Knight"></div>')
                }
                if ((col[i] === "A" && l === 1) || (col[i] === "H" && l === 1)) {
                    document.write('<div class="w_tower on" title="Tower"></div>')
                }
                if ((col[i] === "A" && l === 2) || (col[i] === "B" && l === 2) || (col[i] === "C" && l === 2) || (col[i] === "D" && l === 2) || (col[i] === "E" && l === 2) || (col[i] === "F" && l === 2) || (col[i] === "G" && l === 2) || (col[i] === "H" && l === 2)) {
                    document.write('<div class="w_pawn on" title="Pawn"></div>')
                }         
                if (col[i] === "E" && l === 8) {
                    document.write('<div class="b_king on" title="King"></div>')
                }
                if (col[i] === "D" && l === 8) {
                    document.write('<div class="b_queen on" title="Queen"></div>')
                }
                if ((col[i] === "C" && l === 8) || (col[i] === "F" && l === 8)) {
                    document.write('<div class="b_bishop on" title="Bishop"></div>')
                }
                if ((col[i] === "B" && l === 8) || (col[i] === "G" && l === 8)) {
                    document.write('<div class="b_knight on" title="Knight"></div>')
                }
                if ((col[i] === "A" && l === 8) || (col[i] === "H" && l === 8)) {
                    document.write('<div class="b_tower on" title="Tower"></div>')
                }
                if ((col[i] === "A" && l === 7) || (col[i] === "B" && l === 7) || (col[i] === "C" && l === 7) || (col[i] === "D" && l === 7) || (col[i] === "E" && l === 7) || (col[i] === "F" && l === 7) || (col[i] === "G" && l === 7) || (col[i] === "H" && l === 7)) {
                    document.write('<div class="b_pawn on" title="Pawn"></div>')
                }                 
                document.write('</div>');
