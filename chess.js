    ...
    for (let c = 1; c < 9; c++) {
        ...
        for (let i = 0; i < col.length; i++) {
            ...
            if (j === c) {
                ...
                if (col[i] === "E" && l === 1) {
                    document.write('<div id="w_king" class="w_king on" title="King"></div>')
                }
                if (col[i] === "D" && l === 1) {
                    document.write('<div id="w_queen" class="w_queen on" title="Queen"></div>')
                }
                if ((col[i] === "C" && l === 1) || (col[i] === "F" && l === 1)) {
                    document.write('<div id="w_bishop" class="w_bishop on" title="Bishop"></div>')
                }
                if ((col[i] === "B" && l === 1) || (col[i] === "G" && l === 1)) {
                    document.write('<div id="w_knight" class="w_knight on" title="Knight"></div>')
                }
                ...
                if (col[i] === "D" && l === 8) {
                    document.write('<div id="b_queen" class="b_queen on" title="Queen"></div>')
                }
                if ((col[i] === "C" && l === 8) || (col[i] === "F" && l === 8)) {
                    document.write('<div id="b_bishop" class="b_bishop on" title="Bishop"></div>')
                }
                if ((col[i] === "B" && l === 8) || (col[i] === "G" && l === 8)) {
                    document.write('<div id="b_knight" class="b_knight on" title="Knight"></div>')
                }
                if ((col[i] === "A" && l === 8) || (col[i] === "H" && l === 8)) {
                    document.write('<div id="b_tower" class="b_tower on" title="Tower"></div>')
                }
